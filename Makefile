...
STUDIO     := LIGHTNING_API_KEY=$(LIGHTNING_API_KEY) LIGHTNING_USER_ID=$(LIGHTNING_USER_ID) STUDIO_TEAMSPACE=$(STUDIO_TEAMSPACE) STUDIO_USER=$(STUDIO_USER) STUDIO_NAME=$(STUDIO_NAME) python3 scripts/studio.py
